...
|---|---|---|
| Creating an eval plan, scoping what to evaluate, choosing scenarios | `/eval-suite-planner` | "For a full eval plan with scenario selection and quality signals, run `/eval-suite-planner`." |
