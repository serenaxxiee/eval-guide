# Eval FAQ knowledge base

This companion contains the knowledge-base reference material relocated verbatim from SKILL.md. Open the relevant section whenever fetched content is unavailable, incomplete, or needs methodology support.
