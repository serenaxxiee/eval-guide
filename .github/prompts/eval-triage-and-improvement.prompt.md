...
This prompt uses `skills/eval-guide/playbook.md` as the methodology spine. It also works alongside the **AI Agent Evaluation Scenario Library** (`github.com/microsoft/ai-agent-eval-scenario-library`), which defines supporting scenario patterns and quality dimensions, and the **Triage & Improvement Playbook** (`github.com/microsoft/triage-and-improvement-playbook`), which provides supporting diagnostic frameworks for Step 7.
