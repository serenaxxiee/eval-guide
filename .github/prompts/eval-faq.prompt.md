...
|---|---|---|
| Creating an eval plan or scoping what to evaluate | the eval-suite-planner prompt (see [eval-suite-planner](eval-suite-planner.prompt.md)) | "For a populated Eval Suite Template workbook, use the eval-suite-planner prompt." |
...
Which eval sets should I include?
